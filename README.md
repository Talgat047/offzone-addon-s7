...
|---|---|---|
| U1 | TLC555 | **CMOS**-версия таймера, см. замечание ниже |
| R1 | 200 кОм | задающая цепь |
| R2 | 100 кОм | задающая цепь |
| C1 | 10 мкФ | задающая цепь |
| R3 | 1 кОм | база Q1 |
| Q1 | MMBT3904 | NPN, SOT-23, цоколёвка B-E-C |
| R4 | 100 Ом | общий токозадающий для D1..D3 |
| R5, R6 | 100 Ом | токозадающие для D4, D5 |
| D1..D3 | LED | мигающие (строб / маяк) |
| D4, D5 | LED | постоянные (БАНО) |

### Замечания к схеме со скриншота

1. **Таймер должен быть CMOS.** Биполярный NE555 требует минимум 4,5 В и от 3 В не
   заработает. В схеме стоит TLC555; равноценны LMC555 и ICM7555. В симуляторе
   таймер идеальный, поэтому там это не проявляется.
