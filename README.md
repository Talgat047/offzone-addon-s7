...
| Q1 | MMBT3904 | SOT-23 | C81464 | NPN, цоколёвка B-E-C |
...
Открывается через **File → Open → EasyEDA**. Символы взяты из библиотеки LCSC, так
что у компонентов сразу проставлены корпуса и партномера — схему можно вести в плату.
...
Список цепей побитово совпадает с таблицей выше.
